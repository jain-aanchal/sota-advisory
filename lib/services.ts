...
export const services: Service[] = [
  {
    ...
    short:
      "Measure before you build. We instrument model performance, token spend, and user outcomes so every AI bet is grounded in data, not vibes.",
    long: "Observability-first AI means you never ship a model, agent, or workflow you can't explain to the board. We stand up the metrics, evals, and dashboards first, then map the AI surface area of your business, prioritize bets by ROI and feasibility, and produce a board-ready strategy your team can actually ship against.",
  },
  {
    ...
    long: "We audit inference and token spend end-to-end: model routing, prompt hygiene, caching, batching, and vendor mix. Then we put controls in place, monitored budgets, per-feature unit costs, and margin-aware guardrails, so AI stays a lever, not a leak.",
  },
  {
    slug: "custom-ai-builds",
    title: "Custom AI Builds",
    short:
      "Scoped, hands-on builds from architecture to production. When the platform needs to just work, I own it end-to-end.",
  ...
  },
  {
    ...
    short:
      "Hands-on technical ownership during a transition, or as a permanent fractional partner to founders who need depth without a full-time hire.",
